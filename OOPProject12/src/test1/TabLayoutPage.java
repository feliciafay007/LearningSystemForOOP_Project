...
public class TabLayoutPage {
    ...
    public void addComponentToPane(Container pane) {
        ...
        JPanel card1 = new ResourceProcessor() {
    ...
    private static void createAndShowGUI() {
        ...
        TabLayoutPage demo = new TabLayoutPage();
